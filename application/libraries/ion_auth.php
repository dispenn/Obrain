...
class Ion_auth
{
	 ...
	 * @author Mathew
	 **/
	public function register($username, $password, $email, $additional_data = array(), $group_ids = array(), $brigadies = 0, $brigadies2 = 0) //need to test email activation
	{
		$this->ion_auth_model->trigger_events('pre_account_creation');

        if (isset($additional_data['email_activation']) && $additional_data['email_activation'] == TRUE) {
		...
		if (!$email_activation)
		{
			$id = $this->ion_auth_model->register($username, $password, $email, $additional_data, $group_ids, $brigadies, $brigadies2);
			if ($id !== FALSE)
			{
