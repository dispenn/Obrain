<aside class="right-side">
    ...
    <section class="content">
        <div class="row">
            <div class="col-md-12">
                <form method="post" enctype="multipart/form-data" class="form-horizontal" role="form" action="<?php if(isset($form) && isset($id)) {echo base_url("administrator/edit_right_menu/".$id);} else {echo base_url("administrator/create_right_menu");}?>">
