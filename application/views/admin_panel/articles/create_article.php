<aside class="right-side">
    <section class="content-header"><h1><?php if(isset($form) && isset($id)) {echo 'Редактирование публикации';} else {echo 'Новая публикация';}?></h1></section>
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" enctype="multipart/form-data" class="form-horizontal" role="form" action="<?php if(isset($form) && isset($id)) {echo base_url("administrator/edit_article/".$id);} else {echo base_url("administrator/create_article");}?>">               
                        <div class="row">
                            <div class="col-md-7">
