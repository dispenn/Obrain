 ...
 */
$config['site_title']           = base_url(); //"cms.formfaktor.ru" Site Title, example.com
$config['admin_email']          = "yakovenko.d.n@gmail.com"; // Admin Email, admin@example.com
$config['default_group']        = 'Пользователь';           // Default group, use name
$config['admin_group']          = 'Администратор';              // Default administrators group, use name
...
/*
 ...
 | Default: autorization/
 */
$config['email_templates'] = 'autorization/email/';
