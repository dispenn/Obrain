 ...
 *
 *
 * @property Basic_functions_model $basic_functions_model
 * @property Admin_model $admin_model
 * @property Public_model $public_model
 * @property Ion_auth_model $ion_auth_model
 * @property Rules_model $rules_model
 * @property Catalog_model $catalog_model
 *
 * @property General_functions $general_functions
 * @property Excel_functions $excel_functions
 * @property Crm_functions $crm_functions
